...
def get_xgb_model():
    return XGBClassifier(
        ...
        eval_metric='logloss',
        verbosity=0
        # 🚨 關鍵解鎖：移除 learning_rate=0.05！
        # 讓它使用預設的學習率 (0.3)，讓機率有足夠的推動力跨越 0.53！
    )
...
def load_data_for_backtest():
    ...
    # 🚨 防呆機制補回：缺少的傷兵特徵自動補 0，防止 KeyError
    print("   🔧 正在為歷史資料補齊缺少的動態特徵 (如 MISSING_MIN_SUM 等)...")
